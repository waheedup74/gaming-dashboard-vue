<template>
  <div>
    ...
    <div style="display: flex">
      <div v-if="authStore.loggedIn" id="workspace-menu" :class="{ active: showSidebar }" :style="[brands.length === 1 ? { 'width': '0px' } : '']">
      ...
      <div v-if="authStore.loggedIn"  :class="{ active: showSidebar }" id="sidebar" :style="[brands.length === 1 ? { 'left': '0px' } : '']">
        <a href="/" class="logo">
      ...
      <div :style="[[!authStore.loggedIn ? { width: '100%', padding: '0px' } : {}], [brands.length === 1 ? mainContainerStyle : '']] " class="main-container" >
        <div class="desktop-view">
          <header v-if="authStore.loggedIn">
            <div v-if="authStore.tenantName" class="search-bar">
              ...
              <div  :class="{ open: accountDropdown }" class="account-menu-container">
                <div class="user-section">
                  ...
                  <div class="name-container">
                    ...
                    <p class="role" >{{authStore.email ? authStore.email : 'No email address found'}}</p>
                  </div>
                </div>
